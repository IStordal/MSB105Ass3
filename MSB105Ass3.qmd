...
```{r}
# ag: Denne burde virke også på andre system enn Windows
# har også sett raportert at Sys.setlocale(locale = "nb_NO.UTF-8")
# virker på Windows. Denne bør settes i filen .Rprofile
# som skal ligge her: C:\Users\<YourUsername>\.Rprofile
...
plot_pendlere <- function(data, bosted, aar, top_n = 12, intern = TRUE) {
  
  if (intern == FALSE) data = filter(data, !akom == bkom) 
  
  df <- data %>%
    filter(!akom == 'k0000_TotalBo') |>
    filter(bkom == bosted, aar == !!aar) %>%
    arrange(desc(andel)) %>%
    slice_head(n = top_n) %>%
    mutate(
...
```{r}
plot_pendlere(andel_pendle_data_02_24_long, "k1103", 2024, intern = TRUE)
```
...
I tabellene @tbl-pmat-2002, @tbl-pmat-2005, @tbl-pmat-2010, @tbl-pmat-2015, @tbl-pmat-2023 og @tbl-pmat-2024 er pendlematriser for Bokna-regionen for årene 2002, 2005, 2010, 2015, 2023 og 2024 gjengitt.
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2002
#| tbl-cap: Pendlematrise 2002 for Bokna-regionen.
#| echo: false
pend_mat_2002 |> 
  flextable() |> 
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2005
#| tbl-cap: Pendlematrise 2005 for Bokna-regionen.
#| echo: false
pend_mat_2005 |> 
  flextable() |> 
  fontsize(size = 9, part = "all") |> 
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2010
#| tbl-cap: Pendlematrise 2010 for Bokna-regionen.
#| echo: false
pend_mat_2010 |> 
  flextable() |> 
  fontsize(size = 9, part = "all") |> 
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2015
#| tbl-cap: Pendlematrise 2015 for Bokna-regionen.
#| echo: false
pend_mat_2015 |> 
  flextable() |> 
  fontsize(size = 9, part = "all") |> 
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2023
#| tbl-cap: Pendlematrise 2023 for Bokna-regionen.
#| echo: false
pend_mat_2023 |> 
  flextable() |> 
  fontsize(size = 9, part = "all") |> 
...
#| ft.arraystretch: 1.2
#| label: tbl-pmat-2024
#| tbl-cap: Pendlematrise 2024 for Bokna-regionen.
#| echo: false
pend_mat_2024 |> 
  flextable() |> 
  fontsize(size = 9, part = "all") |> 
